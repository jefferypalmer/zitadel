...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, OrgDCRPolicyAddedEventType, OrgDCRPolicyAddedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, OrgDCRPolicyChangedEventType, OrgDCRPolicyChangedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, OrgDCRPolicyRemovedEventType, OrgDCRPolicyRemovedEventMapper)
