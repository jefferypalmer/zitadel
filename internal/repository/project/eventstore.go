...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, ApplicationRegistrationAccessTokenRotatedType, ApplicationRegistrationAccessTokenRotatedEventMapper)
	// Inline JWKS storage (cavekit-inline-jwks.md R3 / T-016)
	eventstore.RegisterFilterEventMapper(AggregateType, ApplicationOIDCConfigJwksInlineSetType, ApplicationOIDCConfigJwksInlineSetEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, ApplicationOIDCConfigJwksInlineChangedType, ApplicationOIDCConfigJwksInlineChangedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, ApplicationOIDCConfigJwksInlineRemovedType, ApplicationOIDCConfigJwksInlineRemovedEventMapper)
