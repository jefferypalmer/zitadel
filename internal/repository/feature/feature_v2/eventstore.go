...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SystemDynamicClientRegistration, eventstore.GenericEventMapper[SetEvent[bool]])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceDynamicClientRegistration, eventstore.GenericEventMapper[SetEvent[bool]])
}
