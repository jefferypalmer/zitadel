...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceDCRPolicyAddedEventType, InstanceDCRPolicyAddedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceDCRPolicyChangedEventType, InstanceDCRPolicyChangedEventMapper)
